$(".reviews__wrap").slick({
	...
	slidesToScroll: 1,
	autoplay: true,
	prevArrow: '<button class="reviews-arrow__prev"><svg class="reviews-arrow__right icon"><use xlink:href="images/sprite.svg#icon-left"></use></svg></button> ',
	nextArrow: '<button class="reviews-arrow__next"> <svg class="reviews-arrow__right icon"><use xlink:href="images/sprite.svg#icon-left"></use></svg></button>',
});
...
$(".shop-filter__btn").on("click", function (e) {
	e.preventDefault();
...
$(document).ready(function(){
	$(".shop-filter__sort, .product-item__num").styler();
	});
